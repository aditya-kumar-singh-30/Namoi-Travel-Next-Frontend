...
const Footer = () => {
  return (
    <div className='pb-16 pt-16 '>
      <div className='w-[80%] mx-auto items-start grid-cols-1 sm:grid-col-2 grid md:grid-cols-2 lg:grid-cols-4 gap-10 '>
          {/* 1st part */}
          ...
          <div>
            ...
            <div className='mt-6 '>
                ...
                <h1 className='text-base font-bold text-blue-950 mt-1'>+0123 456 789</h1>
            </div>
            <div className='mt-6 '>
