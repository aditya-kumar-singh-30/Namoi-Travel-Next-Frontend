    ...
    <div className='pt-20 pb-20  flex items-center justify-center flex-col bg-[#13357b]'>
      <div className='w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-10' >
        <div>
            ...
            <p className='mt-6 text-gray-200'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum ratione porro tenetur eaque et nulla optio! Deleniti possimus eos atque!</p>
