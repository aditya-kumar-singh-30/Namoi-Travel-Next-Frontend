  ...
  return (
    <div>
      <div className='relative h-[300px] w-full rounded-lg cursor-pointer group overflow-hidden '>
        ...
        <Image src={hotel.image} alt={hotel.name} width={500} height={500} className='overflow-hidden h-full w-full transition-full duration-300 object-cover group-hover:scale-110'/>
      </div>
      {/* content */}
      <div>
