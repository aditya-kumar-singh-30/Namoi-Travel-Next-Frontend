...
const Hero = () => {
  return (
    ...
    <div className='absolute top-0 left-0 w-full h-full bg-gray-900 opacity-90'>
    ...
    <div className='absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        <div className='flex items-center justify-center flex-col w-full h-full'>
            ...
            <SearchBox/>
            <Link href="#" className='rounded px-14 md:px-28 -mt-4 py-2.5 overflow-hidden group bg-rose-600 relative hover:bg-gradient-to-r hover:from-red-500 hover:to-red-400 text-white hover-ring-2 hover:right-offset-2 hover:ring-red-400 transition-all ease-out duration-300'>
