...
const Newsletter = () => {
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
      <BsEnvelopePaper className='w-16 h-16 mt-16 text-white'/>
      <h1 className='text-lg sm:text-xl  md:text-xl text-white font-semibold mt-10 tracking-widest'>Your Travel Journey Starts Here</h1>
      ...
      <div className='w-full '>
        ...
        <button className='px-6 py-3.5 bg-blue-900 text-white hover:bg-blue-950 transition-all duration-200 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none'>Subscribe</button>
      </div>
    </div>
  );
}
